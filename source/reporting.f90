module reporting
    ...
    use settings, only: N_X, N_Y, N_STEPS, N_CELLS, &
        ...
        USE_UNROLLED_KERNELS, USE_UNIVERSAL_KERNELS, USE_INNER_OUTER_KERNELS, USE_STAGED_HALO_EXCHANGE, &
...
contains
    ...
    subroutine print_run_summary( &
        ...
        print '(A,T27,A,L1)',    "use_inner_outer_kernels", "= ", USE_INNER_OUTER_KERNELS
    ...
    subroutine print_execution_summary( &
        ...
        real(real64), intent(in) :: export_seconds
        real(real64), intent(in) :: progress_seconds
        ...
        call print_execution_time_row("progress display", progress_seconds, elapsed_seconds)
