...
contains
    ...
    subroutine fuzed_unrolled_pull_streaming_collision_inner_local_SW( &
    ...
    end subroutine fuzed_unrolled_pull_streaming_collision_inner_local_SW


    subroutine fuzed_unrolled_pull_streaming_collision_outer_local_SW( &
        n_x_local, n_y_local, write_macro_fields, omega, f, f_next, rho, u_x, u_y &
        )
        ! inputs
        integer(int32), intent(in) :: n_x_local
