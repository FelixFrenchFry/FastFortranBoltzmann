...
contains
    ...
    subroutine deallocate_halo_buffers( &
        ...
        if (allocated(halo_buffers%window_y)) then
            deallocate(halo_buffers%window_y)
        end if
        ...
        if (allocated(halo_buffers%recv_bottom)) then
            deallocate(halo_buffers%recv_bottom)
        end if
        if (allocated(halo_buffers%recv_top)) then
            deallocate(halo_buffers%recv_top)
        end if
        if (allocated(halo_buffers%recv_macro_left)) then
