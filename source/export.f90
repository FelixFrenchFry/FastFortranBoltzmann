module export
    ...
    use settings, only: N_X, N_Y, N_STEPS, N_CELLS, N_DIRS, C_X, C_Y, C_X_FP, C_Y_FP, W, &
        ...
        USE_UNROLLED_KERNELS, USE_UNIVERSAL_KERNELS, USE_SINGLE_SYNC_EXCHANGE, &
...
contains
    ...
    subroutine export_metadata( &
        ...
        write(unit, '(A,A,A)') '  "use_single_sync_exchange": ', &
            trim(logical_to_json(USE_SINGLE_SYNC_EXCHANGE)), ','
        write(unit, '(A)') ""
#ifdef FFB_FP64
