...
DOMAIN_DECOMP_CASE_SETS = {
    ...
    "decompositions_360": CASE_DECOMPOSITIONS_360,
    "decompositions_576": CASE_DECOMPOSITIONS_576,
    "small": CASE_SMALL,
